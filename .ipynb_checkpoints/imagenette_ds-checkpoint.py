...
class AddGaussianNoise(object):
    '''
    Add gaussian noise to transform dataset
    '''
...
def load_imagenette(BATCH_SIZE: int=16, dir_name: str='./data/'):
    ...
    #                              T.RandomRotation(45), T.RandomVerticalFlip(), 
    #                              T.ColorJitter(brightness=0.1, contrast=0.2, saturation=0, hue=0), T.ToTensor(),
